...
public class Action {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "fixes", namespace = "http://maven.apache.org/changes/1.0.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "dueto", namespace = "http://maven.apache.org/changes/1.0.0", type = JAXBElement.class, required = false)
    })
    @XmlMixed
